...
> **TODO:** Windsurf's global skill install path and config format need to be confirmed
> before this adapter is production-ready. Update this file and `lib/install.js`
> (`AGENTS.windsurf.skillsDir`) once verified.
